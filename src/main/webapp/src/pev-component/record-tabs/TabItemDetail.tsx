            ...
            <Grid item xs={12} sx={{ mt: 2, height: 'calc(100% - 325px)' }}>
                <Box display={'flex'} alignItems={'center'}>
                    <Grid container>
                        ...
                        <Grid item xs={5} display={'flex'} alignItems={'center'}>
                            <Typography variant={'body1'}>전체: 0</Typography>
                        ...
                        <Grid item xs={5}>
                            <FormGroup sx={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'center', flexDirection: 'row' }}>
                                <FormControlLabel
                                    sx={{ height: 30 }}
                                    control={<Checkbox size={'small'} />}
                ...
                <Box height={'calc(100% - 46.75px)'}>
                    <DataGrid height={'100%'} showBorders={true} showColumnLines={true} showRowLines={true}>
                        ...
                        <Column dataField={'writingDate'} caption={'항목구분'} alignment={'center'} width={100} />
                        <Column dataField={'writingDeptNm'} caption={'항목명'} alignment={'center'} />
                        <Column dataField={'itemNm'} caption={'작성일자'} width={120} alignment={'center'} />
                        <Column dataField={'itemNm'} caption={'진료과'} width={120} alignment={'center'} />
                        <Column dataField={'itemNm'} caption={'작성자'} width={100} alignment={'center'} />
