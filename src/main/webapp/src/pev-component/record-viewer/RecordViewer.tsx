    ...
    return (
        <Box display={'flex'} justifyContent={'center'}>
            <Box display={'flex'} width={'100%'} justifyContent={'space-between'}>
                <Box position={'fixed'} top={98} left={drawerOpen ? finderWidth + 12 : 32} display={'flex'} flexDirection={'column'}>
                ...
                <Box position={'fixed'} top={98} right={24} display={'flex'} flexDirection={'column'}>
