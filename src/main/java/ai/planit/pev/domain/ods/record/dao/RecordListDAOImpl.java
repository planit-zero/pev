...
public class RecordListDAOImpl implements RecordListDAO {
    ...
    @Override
    public List<Record.Response> getNrBloodDialysisRecordList(Record.Request request) {
        return sqlSessionTemplate.selectList("getNrBloodDialysisRecordList", request);
    }
    ...
    @Override
    public List<Record.Response> getCrCprRecordList(Record.Request request) {
        return sqlSessionTemplate.selectList("getCrCprRecordList", request);
    }
