...
VALUES
-- 기존 프로젝트 (3건)
('IRB-2024-001', '테스트 연구 프로젝트 1', '2024-01-01', '2030-12-31', '2024-01-01', '2', 100, '12345'),
('IRB-2024-002', '테스트 연구 프로젝트 2', '2024-06-01', '2030-05-31', '2024-05-15', '1', 50, '12345'),
('IRB-2024-003', '테스트 연구 프로젝트 3 (면제)', '2030-03-01', NULL, '2024-03-01', '4', 0, '12345'),
-- 추가 프로젝트 (5건)
...
('IRB-2024-001', 'RID-001-0001', '000565359'),
('IRB-2024-001', 'RID-001-0002', '001446894'),
('IRB-2024-001', 'RID-001-0003', '001436057'),
('IRB-2024-001', 'RID-001-0004', '001527024'),
('IRB-2024-001', 'RID-001-0005', '001573353')
ON CONFLICT DO NOTHING;
